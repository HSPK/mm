...
class SmartAlbumsApi(DbApi):
    ...
    async def get(self, album_id: int) -> dict[str, Any] | None:
        try:
    ...
    async def update(
        ...
        return await self.get(album_id)
    ...
    async def toggle(self, album_id: int) -> dict[str, Any] | None:
        try:
