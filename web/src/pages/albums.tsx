...
export default function AlbumsPage() {
    ...
    const { setFilter, setFilters, total } = useMediaStore()
    ...
    return (
        <div className="px-4 pb-24 space-y-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                    ...
                    {(typeDist.photo ?? 0) > 0 && (
                        <AlbumCard
                            ...
                            onClick={() => goLibraryWith({ type: "photo" })}
                        />
                    )}
                    {(typeDist.video ?? 0) > 0 && (
                        <AlbumCard
                            ...
                            onClick={() => goLibraryWith({ type: "video" })}
                        />
                    )}
                    <AlbumCard
                        icon={Star}
            ...
            {/* ── Trash (placeholder) ── */}
            <section>
                <SectionHeader icon={Trash2} title="Recently Deleted" />
                <div className="rounded-2xl bg-secondary/30 border border-border/60 p-6 flex flex-col items-center justify-center text-center gap-2">
